...
public interface ChatApi {
    ...
    @ApiOperation(value = "Найти чат по айди", nickname = "chat-get-by-id", response = Void.class)
    @ApiResponses(value = {
    ...
    @ApiOperation(value = "Получение всех чатов пользователя", nickname = "chat-list-get-by-user-id", response = Void.class)
    @ApiResponses(value = {
    ...
    @ApiOperation(value = "Получить список всех чатов", nickname = "chat-list-get", response = Void.class)
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "Список составлен", response = List.class),
            @ApiResponse(code = 400, message = "Ошибка валидации")})
    @GetMapping
